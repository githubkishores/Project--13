...
function spawnApples(){
  if(frameCount %100===0){
   apple=createSprite(200, 10, 40, 20);
   apple.velocityY=3
   apple.addImage(appleImg)
   apple.scale=0.1
   apple.x=Math.round(random(65, 345))
   apple.lifeTime=150;
 }
}
function spawnOrangeleaf(){
   if(frameCount %200===0){
    orangeLeaf=createSprite(200,20, 20, 20);
    orangeLeaf.velocityY=3
    orangeLeaf.addImage(orangeImg)
    orangeLeaf.scale=0.1
    orangeLeaf.x=Math.round(random(65, 345))
